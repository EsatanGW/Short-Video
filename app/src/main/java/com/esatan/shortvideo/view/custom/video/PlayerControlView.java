 ...
 */
package com.esatan.shortvideo.view.custom.video;
...
public class PlayerControlView extends FrameLayout {
    ...
    public PlayerControlView(
        ...
        boolean showInformationBar = false;
        ...
        if (playbackAttrs != null) {
            ...
            try {
                ...
                showInformationBar = a.getBoolean(R.styleable.PlayerControlView_show_information_bar, showInformationBar);
                showBackButton = a.getBoolean(R.styleable.PlayerControlView_show_back_button, showBackButton);
        ...
        controlViewLayoutManager = new PlayerControlViewLayoutManager(this, showInformationBar, showBackButton);
        ...
        settingIcons[SETTINGS_PLAYBACK_SPEED_POSITION] =
                resources.getDrawable(androidx.media3.ui.R.drawable.exo_styled_controls_speed);
        ...
        settingIcons[SETTINGS_AUDIO_TRACK_SELECTION_POSITION] =
                resources.getDrawable(androidx.media3.ui.R.drawable.exo_styled_controls_audiotrack);
        ...
        subtitleOnButtonDrawable = resources.getDrawable(androidx.media3.ui.R.drawable.exo_styled_controls_subtitle_on);
        subtitleOffButtonDrawable = resources.getDrawable(androidx.media3.ui.R.drawable.exo_styled_controls_subtitle_off);
        ...
        fullScreenExitDrawable = resources.getDrawable(androidx.media3.ui.R.drawable.exo_styled_controls_fullscreen_exit);
        fullScreenEnterDrawable =
                resources.getDrawable(androidx.media3.ui.R.drawable.exo_styled_controls_fullscreen_enter);
        repeatOffButtonDrawable = resources.getDrawable(androidx.media3.ui.R.drawable.exo_styled_controls_repeat_off);
        repeatOneButtonDrawable = resources.getDrawable(androidx.media3.ui.R.drawable.exo_styled_controls_repeat_one);
        repeatAllButtonDrawable = resources.getDrawable(androidx.media3.ui.R.drawable.exo_styled_controls_repeat_all);
        shuffleOnButtonDrawable = resources.getDrawable(androidx.media3.ui.R.drawable.exo_styled_controls_shuffle_on);
        shuffleOffButtonDrawable = resources.getDrawable(androidx.media3.ui.R.drawable.exo_styled_controls_shuffle_off);
        ...
        ViewGroup bottomBar = findViewById(androidx.media3.ui.R.id.exo_bottom_bar);
    ...
    public ViewGroup getInformationBar() {
        return controlViewLayoutManager.getInformationBar();
    }

    public void setBackButtonClickListener(OnClickListener listener) {
        controlViewLayoutManager.setBackButtonClickListener(listener);
    }
        ...
        if (playPauseButton != null) {
            if (shouldShowPauseButton()) {
                ((ImageView) playPauseButton)
                        .setImageDrawable(resources.getDrawable(androidx.media3.ui.R.drawable.exo_styled_controls_pause));
                playPauseButton.setContentDescription(
                        resources.getString(androidx.media3.ui.R.string.exo_controls_pause_description));
            } else {
                ((ImageView) playPauseButton)
                        .setImageDrawable(resources.getDrawable(androidx.media3.ui.R.drawable.exo_styled_controls_play));
                playPauseButton.setContentDescription(
                        resources.getString(androidx.media3.ui.R.string.exo_controls_play_description));
            }
        }
    }
