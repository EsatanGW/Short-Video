...
/* package */ final class PlayerControlViewLayoutManager {
    ...
    @Nullable
    private ViewGroup informationBar;
    @Nullable
    ...
    public PlayerControlViewLayoutManager(PlayerControlView playerControlView, boolean showInformationBar, boolean showBackButton) {
        ...
        if (showInformationBar) {
            informationBar = playerControlView.findViewById(R.id.information_bar);
        } else {
            playerControlView.findViewById(R.id.information_bar).setVisibility(View.GONE);
        }
        ...
        fadeOutAnimator.addUpdateListener(
                animation -> {
                    ...
                    if (backButton != null) {
                        backButton.setAlpha(animatedValue);
                    }
                });
        ...
        float translationYForProgressBar =
                resources.getDimension(R.dimen.video_controller_height);
//                        - resources.getDimension(androidx.media3.ui.R.dimen.exo_styled_progress_bar_height);
        float translationYForNoBars = resources.getDimension(R.dimen.video_controller_height);
...
//                .with(ofTranslationY(0, translationYForProgressBar, timeBar))
                ...
                .with(ofTranslationY(0, translationYForProgressBar, informationBar));
...
//                .play(ofTranslationY(translationYForProgressBar, translationYForNoBars, timeBar))
                ...
                .with(ofTranslationY(translationYForProgressBar, translationYForNoBars, informationBar));
...
//                .with(ofTranslationY(0, translationYForNoBars, timeBar))
                ...
                .with(ofTranslationY(0, translationYForNoBars, informationBar));
...
//                .with(ofTranslationY(translationYForProgressBar, 0, timeBar))
                ...
                .with(ofTranslationY(translationYForProgressBar, 0, informationBar));
...
//                .with(ofTranslationY(translationYForNoBars, 0, timeBar))
                ...
                .with(ofTranslationY(translationYForNoBars, 0, informationBar));
...
//      playerControlView.setVisibility(View.VISIBLE);
    ...
    private void setControlViewVisible(boolean isVisible) {
        int visibility = isVisible ? View.VISIBLE : View.GONE;
        if (controlsBackground != null) controlsBackground.setVisibility(visibility);
        if (centerControls != null) centerControls.setVisibility(visibility);
        if (backButton != null) backButton.setVisibility(visibility);
        if (bottomBar != null) bottomBar.setVisibility(isVisible ? View.VISIBLE : View.INVISIBLE);
        if (minimalControls != null) minimalControls.setVisibility(visibility);
        if (basicControls != null) basicControls.setVisibility(visibility);
        if (extraControls != null) extraControls.setVisibility(visibility);
        if (extraControlsScrollView != null) extraControlsScrollView.setVisibility(visibility);
        if (timeView != null) timeView.setVisibility(visibility);
        if (timeBar != null) timeBar.setVisibility(visibility);
        if (overflowShowButton != null) overflowShowButton.setVisibility(visibility);
        for (View v : shownButtons) {
            if (v == bottomBar) continue;
    ...
    public void setBackButtonClickListener(View.OnClickListener listener) {
        if (backButton != null) backButton.setOnClickListener(listener);
    }
}
